...
public final class RedisOptions implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return deployMode == that.deployMode &&
				Objects.equals(opOptions, that.opOptions) &&
				Objects.equals(lookupOptions, that.lookupOptions) &&
				Objects.equals(redisClientOptions, that.redisClientOptions);
	}

	@Override
	public int hashCode() {
		return Objects.hash(deployMode, opOptions, lookupOptions, redisClientOptions);
	}
}
